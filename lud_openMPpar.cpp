...
void mat_mul(float** l, float** u, int size, float** lu)
{
...
void mat_sub(float** a, float** lu, int size, float** a_minus_lu)
{
...
//L1 norm of a matrix                                                                                                                                        
void mat_L1_norm(float** a_minus_lu, int size, float L1_norm)
{
  L1_norm = 0.0;
...
//initialize the matrices                                                                                                                                    
 void initialize_matrices(float** a, float** l, float** u, float** lu, float** a_minus_lu,  int size)
 {
...
int main(int argc, char** argv)
{
	...
	float** lu = new float* [size];
        float** a_minus_lu = new float* [size];

	initialize_matrices(a, l, u, lu, a_minus_lu, size);
	//fill a with random values
	random_fill(a, size);
	//print A
	//cout << "A Matrix: " << endl;
	...
	cout << "L*U Matrix:" << endl;*/                                                                                                                     
        ...
        mat_sub(a, lu, size, a_minus_lu);
        float L1_norm = 0.0;
        mat_L1_norm(a_minus_lu, size, L1_norm);
        cout << "L1 norm of A - LU = " << L1_norm << endl;
